<!-- source: action_and_event_data_generation/ext_replicator-object/distribution_visualizer.html | title: Distribution Visualizer — Isaac Sim Documentation -->
...
[image: ../../_images/isim_5.0_replicator_ext-isaacsim.replicator.object-0.4.2_viewport_ui_open_distribution_visualizer.webp]

- Create a torus, a dome light; focus on the torus by pressing “F”; and switch to path tracing mode, as shown below.
[image: ../../_images/isim_5.0_replicator_ext-isaacsim.replicator.object-0.4.2_viewport_ui_create_torus.webp]
...
- Change the value of rotateY and rotateX to observe how the torus rotates. More information about the scene graph can be found in Transformation .
So far, the steps are shown below:
[image: ../../_images/isim_5.0_replicator_ext-isaacsim.replicator.object-0.4.2_viewport_ui_show_xform_ops.webp]
...
[image: ../../_images/isim_5.0_replicator_ext-isaacsim.replicator.object-0.4.2_viewport_ui_show_distribution.webp]

- To randomize a prim IRO in this way, insert a section like this in our description file:
