<!-- source: action_and_event_data_generation/ext_replicator-object/mutable.html | title: Mutable — Isaac Sim Documentation -->
...
- Geometry the things we want to observe

- Light how we observe things
...
- 0.7
```
Specially, you can do common computer vision operations, such as color mapping to a mesh that has a RGB image as diffuse texture, by doing:
