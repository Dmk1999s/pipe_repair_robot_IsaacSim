<!-- source: action_and_event_data_generation/ext_sensors_rtx_placement/camera_placement.html | title: Camera Placement — Isaac Sim Documentation -->
...
- Activate camera placement tool panel .
...
- In the Stage tab, select all camera prims under `World/Cameras` prim.

- Return to the Camera Placement Tool panel and click Show Selected Camera Coverage to visualize the coverage of the selected cameras.
