<!-- source: gui/preferences.html | title: Preferences — Isaac Sim Documentation -->

# Preferences
The Preferences panel is found under `Edit > Preferences` and hosts a list of settings that are applicable to the current app. Here we list the most commonly modified ones. These settings apply to the entire application and are not stored with individual USD stages.
...
[image: Audio Application Preferences.]
