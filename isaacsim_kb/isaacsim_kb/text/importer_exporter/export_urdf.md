<!-- source: importer_exporter/export_urdf.html | title: Tutorial: Export URDF — Isaac Sim Documentation -->
...
[image: The USD to URDF Exporter UI]
...
[image: The Franka URDF viewed with the URDF Viewer Example website]
...
[image: Mesh directory path field]
...
[image: The Franka USD with a mesh sphere that does not have collision API and is visible]
...
- Drag your output directory into the URDF Viewer Example website to view the results.

- Verify that your results are similar to:
[image: The Franka URDF with a mesh sphere that does not have the collision API and is visible]
...
[image: The Franka URDF with a mesh sphere that does have the collision API and is visible]
...
[image: The Franka USD with the sphere set to be invisible]
...
[image: The Franka URDF with a mesh sphere that does have the collision API and is invisible]
