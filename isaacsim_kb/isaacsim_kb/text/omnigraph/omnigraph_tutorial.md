<!-- source: omnigraph/omnigraph_tutorial.html | title: Isaac Sim Omnigraph Tutorial — Isaac Sim Documentation -->
...
[image: ../_images/isim_4.5_base_tut_viewport_omnigraph_jetbot.png]Jetbot on the stage
Note
Click play! Validate that the JetBot falls and lands on the stage. Click stop before continuing.
Depending on your default render settings, the camera of the JetBot may have a placeholder mesh (it looks like a gray television camera). To hide these meshes, click on the icon in the viewport and select Show By Type –> Cameras.

### Building the Graph

- Select Window > Graph Editors > Action Graph from the dropdown menu at the top of the editor. The Graph Editor appears in the same pane as the Content browser.
...
[image: ../_images/isim_4.5_base_tut_gui_omnigraph_jetbot_joints.png]Stage Tree
...
[image: ../_images/isim_4.5_base_tut_gui_jetbot_controller_graph.webp]
...
- More in-depth concepts in OmniGraph

- More details about all the OmniGraph shortcuts Commonly Used Omnigraph Shortcuts

- Examples for composing OmniGraph via Python scripting: OmniGraph via Python Scripting Tutorial

- Examples for writing custom Python nodes: Custom Python Nodes
