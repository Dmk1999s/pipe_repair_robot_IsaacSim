<!-- source: py/api/classisaacsim_1_1ros2_1_1bridge_1_1_ros2_bounding_box2_d_message.html | title: Ros2BoundingBox2DMessage — Isaac Sim -->

# Ros2BoundingBox2DMessage
Fully qualified name: `isaacsim::ros2::bridge::Ros2BoundingBox2DMessage`
classRos2BoundingBox2DMessage:publicisaacsim ::ros2 ::bridge ::Ros2Message

Class implementing a `vision_msgs/msg/Detection2DArray` message.
Provides functionality to write ROS 2 Detection2DArray messages that contain 2D bounding box detection information.
Subclassed by isaacsim::ros2::bridge::Ros2BoundingBox2DMessageImpl
Public Functions
...
- bboxArray – [in] Array of `Bbox2DData` struct.
