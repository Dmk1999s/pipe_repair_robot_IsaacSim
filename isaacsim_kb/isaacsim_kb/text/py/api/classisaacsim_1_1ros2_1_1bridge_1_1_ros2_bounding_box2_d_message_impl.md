<!-- source: py/api/classisaacsim_1_1ros2_1_1bridge_1_1_ros2_bounding_box2_d_message_impl.html | title: Ros2BoundingBox2DMessageImpl — Isaac Sim -->

# Ros2BoundingBox2DMessageImpl
Fully qualified name: `isaacsim::ros2::bridge::Ros2BoundingBox2DMessageImpl`
classRos2BoundingBox2DMessageImpl:publicisaacsim ::ros2 ::bridge ::Ros2BoundingBox2DMessage ,privateisaacsim ::ros2 ::bridge ::Ros2MessageInterfaceImpl

Implementation of ROS 2 2D Bounding Box message.
Handles the creation and manipulation of vision_msgs/msg/Detection2DArray messages, which contain 2D object detection results.
Public Functions
Ros2BoundingBox2DMessageImpl()
...
- bboxArray – [in] Array of 2D bounding box data
