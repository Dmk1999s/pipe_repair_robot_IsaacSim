<!-- source: py/api/classisaacsim_1_1sensors_1_1physx_1_1_lidar_sensor.html | title: LidarSensor — Isaac Sim -->

# LidarSensor
Fully qualified name: `isaacsim::sensors::physx::LidarSensor`
classLidarSensor:publicisaacsim ::sensors ::physx ::RangeSensorComponentBase <PrimType>
...
Public Functions
explicitLidarSensor(omni ::physx ::IPhysx*physxPtr)
...
inlinestd ::vector<float>&getBeamTimeData()
