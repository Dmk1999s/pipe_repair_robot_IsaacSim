<!-- source: py/source/extensions/isaacsim.asset.importer.urdf/docs/index.html | title: [isaacsim.asset.importer.urdf] Urdf Importer Extension — Isaac Sim -->
...
exts."omni.kit.window.filepicker".detail_width_init | Set the initial width of the file picker to 390 | 390
exts."omni.kit.window.filepicker".detail_width_min | Set the minimum width of the file picker to 390 | 390
exts."omni.kit.window.filepicker".detail_width_max | Set the maximum width of the file picker to 600 | 600
[/TABLE]
