<!-- source: py/source/extensions/isaacsim.benchmark.services/docs/index.html | title: [isaacsim.benchmark.services] Benchmark Services — Isaac Sim -->
...
metrics.nvdataflow_default_test_suite_name | Default test suite name. | str | 'Isaac Sim Benchmarks'
metrics.randomize_filename_prefix | Whether to add a randomly generated string as a prefix to the output filename to distinguish runs. | bool | False
[/TABLE]
