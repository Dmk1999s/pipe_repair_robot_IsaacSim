<!-- source: py/source/extensions/isaacsim.replicator.domain_randomization/docs/ogn/OgnWritePhysicsRigidPrimView.html | title: Write Physics Attribute using Tensor API — Isaac Sim -->
