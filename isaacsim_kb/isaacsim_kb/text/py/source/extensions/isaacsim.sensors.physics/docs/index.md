<!-- source: py/source/extensions/isaacsim.sensors.physics/docs/index.html | title: [isaacsim.sensors.physics] Isaac Sim Physics Sensor Simulation — Isaac Sim -->
...
#### Commands
classIsaacSensorCreatePrim(*args:Any, **kwargs:Any)
Bases: `Command`

classIsaacSensorCreateContactSensor(*args:Any, **kwargs:Any)
Bases: `Command`

classIsaacSensorCreateImuSensor(*args:Any, **kwargs:Any)
Bases: `Command`
...
)→<isaacsim.sensors.physics.impl.effort_sensor.EsSensorReadingobjectat0x7fd61fb26390>get_sleep_threshold()→float
