<!-- source: python_scripting/core_api_overview.html | title: Core API Overview — Isaac Sim Documentation -->
...
[image: ../_images/WorldSceneStage.png]Everything in USD is a primitive (prim) with attributes.
