<!-- source: robot_setup/asset_validation.html | title: Asset Validation — Isaac Sim Documentation -->
...
To open the Asset Validation window, navigate to Window > Asset Validator. For more information on the Asset Validation window, refer to Asset Validator .
