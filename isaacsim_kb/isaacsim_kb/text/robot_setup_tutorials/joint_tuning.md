<!-- source: robot_setup_tutorials/joint_tuning.html | title: Tutorial 11: Tuning Joint Drive Gains — Isaac Sim Documentation -->

# Tutorial 11: Tuning Joint Drive Gains

## Learning Objectives
In this tutorial, you learn how to use the Gain Tuner to tune joints on a robot so that it behaves as expected. For a more detailed explanation of how the Gain Tuner works and the physics behind it, see Gain Tuner Extension .
[image: Gain Tuner Overview]

### Prerequisite

- If the robot is in URDF format, follow Tutorial: Import URDF to import a URDF file into Isaac Sim.
...
- We also encourage you to setup your robot based on recommended Asset Structure .
...
[image: Gain Tuner Results for a poorly tuned UR10e robot.]Note
...
- Read Gain Tuner Extension for more details on the physical mechanics relating joint gains to derived motions, and how the Gain Tuner works.

- Use Adding a Controller , if you wish to send direct effort commands and implement your own joint drives.
