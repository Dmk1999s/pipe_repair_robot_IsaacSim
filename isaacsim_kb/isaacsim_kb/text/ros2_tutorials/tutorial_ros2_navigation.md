<!-- source: ros2_tutorials/tutorial_ros2_navigation.html | title: ROS 2 Navigation — Isaac Sim Documentation -->
...
- This tutorial requires `carter_navigation`, `iw_hub_navigation`, and `isaac_ros_navigation_goal` ROS2 packages, which are provided as part of your NVIDIA Isaac Sim download. These ROS2 packages are located inside the appropriate `ros2_ws`. They contain the required launch file, navigation parameters, and robot model. Complete ROS 2 Installation , make sure the ROS 2 workspace environment is setup correctly.
