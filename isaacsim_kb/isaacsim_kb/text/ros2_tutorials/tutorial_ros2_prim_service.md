<!-- source: ros2_tutorials/tutorial_ros2_prim_service.html | title: ROS 2 Service for Manipulating Prims Attributes — Isaac Sim Documentation -->
...
- The Isaac Sim ROS 2 Workspace (with the `isaac_ros2_messages` ROS 2 package) built and sourced in the terminal where the service will be called. Refer to Setting Up Workspaces for more details.
Note
...
Note
Make sure the Isaac Sim ROS 2 Workspace (with the `isaac_ros2_messages` ROS 2 package) is built and sourced in the terminal where the service will be called. See Setting Up Workspaces for more details. Isaac Sim already has this service included as part of the internal ROS 2 bridge libraries.
