<!-- source: synthetic_data_generation/tutorial_replicator_grasping_sdg.html | title: Grasping Synthetic Data Generation — Isaac Sim Documentation -->
...
[image: Grasping workflow overview]
...
[image: Example stage with a gripper and objects for grasping]
...
[image: Grasping UI window main interface]
...
[image: Grasping UI: Gripper joints configuration]
...
[image: Grasping UI: Gripper grasp phases configuration]For each phase (for example, “Open”, “Close”), you specify:
...
[image: Grasping UI: Object and grasp pose sampler configuration]
...
[image: Resulting grasp poses from the antipodal grasp sampler]
...
[image: Using the Measure Tool for gripper and standoff distances]
...
[image: Grasping UI: Simulation settings]
...
[image: Grasping UI: Configuration management]
